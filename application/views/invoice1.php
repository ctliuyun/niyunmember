...
<html>
  <head>
    ...
    <title>欢迎使用 | NiyunMMS | 倪云代理商会员管理系统</title>
    ...
    <!--link rel="stylesheet" href="<?php echo base_url(); ?>static/css/skin-blue-light.min.css"-->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <header class="main-header">
        ...
        <a href="#" class="logo">
          ...
          <span class="logo-mini"><b>倪</b>云</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>Niyun</b>MMS</span>
        </a>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown user user-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">邱 吾 权</span>
                </a>
                <ul class="dropdown-menu">
                  <!-- User image -->
          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview active">
              ...
              <ul class="treeview-menu">
                ...
                <li><a href="profile.html"><i class="fa fa-circle-o"></i> 个人信息 </a></li>
      ...
      <div class="content-wrapper">
        ...
        <div class="pad margin no-print">
          <div class="callout callout-info" style="margin-bottom: 0!important;">
            <h4><i class="fa fa-info"></i> 注 意:</h4>
            此页已被增强，可以用于打印测试。点击底部的打印按钮，进行测试。
          </div>
        </div>
        ...
        <section class="invoice">
          ...
          <div class="row">
            <div class="col-xs-12">
              <h2 class="page-header">
                <i class="fa fa-globe"></i> 倪云电信代理商会员管理系统
                <small class="pull-right">日期: <?php echo date('Y-m-d H:i:s'); ?></small>
              </h2>
            </div><!-- /.col -->
          </div>
          <!-- info row -->
          ...
          <div class="row">
            ...
            <div class="col-xs-6">
              ...
              <img src="<?php echo base_url(); ?>static/img/credit/visa.png" alt="Visa">
              <img src="<?php echo base_url(); ?>static/img/credit/mastercard.png" alt="Mastercard">
              <img src="<?php echo base_url(); ?>static/img/credit/american-express.png" alt="American Express">
              <img src="<?php echo base_url(); ?>static/img/credit/paypal2.png" alt="Paypal">
          ...
          <div class="row no-print">
            <div class="col-xs-12">
              ...
              <button class="btn btn-primary pull-right" style="margin-right: 5px;"><i class="fa fa-download"></i> 生成 PDF 文档</button>
            </div>
          </div>
        </section><!-- /.content -->
      ...
      <footer class="main-footer no-print">
        ...
        <strong>版权 &copy; 2014-2015 <a href="http://almsaeedstudio.com">倪云</a> </strong> 保留全部权利
      </footer>
    ...
    <!-- FastClick -->
    <script src="<?php echo base_url(); ?>static/js/fastclick.min.js"></script>
    <!-- AdminLTE App -->
